...
PYBIND11_MODULE(raspalib, m)
{
  ...
  pybind11::class_<Atom>(m, "Atom")
      .def(pybind11::init<>())
      .def(pybind11::init<double3, double, double, std::uint32_t, std::uint16_t, std::uint8_t, std::uint8_t,
                          std::uint8_t>(),
  ...
  forceField
      ...
      .def("findPseudoAtom", static_cast<std::optional<std::size_t> (ForceField::*)(const std::string&) const>(
                                 &ForceField::findPseudoAtom))
  ...
  cifReader.def("expandDefinedAtomsToUnitCell", &CIFReader::expandDefinedAtomsToUnitCell);
  ...
  pybind11::class_<MCMoveProbabilities>(m, "MCMoveProbabilities")
      .def(pybind11::init<double, double, double, double, double, double, double, double, double, double, double,
           ...
           pybind11::arg("partialReinsertionCBMCProbability") = 0.0, pybind11::arg("identityChangeProbability") = 0.0,
           pybind11::arg("swapProbability") = 0.0, pybind11::arg("swapCBMCProbability") = 0.0,
           pybind11::arg("swapCFCMCProbability") = 0.0, pybind11::arg("swapCBCFCMCProbability") = 0.0,
           pybind11::arg("gibbsVolumeChangeProbability") = 0.0, pybind11::arg("gibbsSwapCBMCProbability") = 0.0,
           pybind11::arg("gibbsSwapCFCMCProbability") = 0.0, pybind11::arg("widomProbability") = 0.0,
  ...
  pybind11::class_<MoveStatistics<double3>>(m, "MoveStatisticsDouble3")
      //.def_property_readonly("counts", [](MoveStatistics<double3> const &s) { return std::vector<double>{s.counts.x,
      // s.counts.y, s.counts.z};})
  ...
  component
      .def(pybind11::init<std::size_t, const ForceField&, std::string, double, double, double, std::vector<Atom>,
           ...
           pybind11::arg("definedAtoms") = std::vector<Atom>(),
           pybind11::arg("connectivityTable") = ConnectivityTable(),
  ...
  pybind11::class_<SampleMovie>(m, "SampleMovie")
      .def(pybind11::init<std::size_t, std::size_t, bool>(), pybind11::arg("systemId"), pybind11::arg("sampleEvery"),
           pybind11::arg("restrictToBox") = true);
  ...
  pybind11::class_<AverageEnergyType>(m, "AverageEnergyType")
      .def(pybind11::init<double, double, double, double>(), pybind11::arg("totalEnergy") = 0.0,
           pybind11::arg("VanDerWaalsEnergy") = 0.0, pybind11::arg("CoulombEnergy") = 0.0,
           pybind11::arg("polarizationEnergy") = 0.0)
  ...
  property_energy_grid.def(
      pybind11::init<std::size_t, std::size_t, int3, std::size_t, std::size_t, std::vector<std::size_t>,
                     PropertyDensityGrid::Normalization, PropertyDensityGrid::Binning>(),
      pybind11::arg("numberOfFrameworks"), pybind11::arg("numberOfComponents"), pybind11::arg("numberOfGridPoints"),
      pybind11::arg("sampleEvery"), pybind11::arg("writeEvery"), pybind11::arg("densityGridPseudoAtomsList"),
  ...
  pybind11::class_<PropertyConventionalRadialDistributionFunction> conv_rdf(
      m, "PropertyConventionalRadialDistributionFunction");
  conv_rdf
      .def(pybind11::init<std::size_t, std::size_t, std::size_t, double, std::size_t, std::size_t>(),
           pybind11::arg("numberOfBlocks"), pybind11::arg("numberOfPseudoAtoms"), pybind11::arg("numberOfBins"),
           pybind11::arg("range"), pybind11::arg("sampleEvery"), pybind11::arg("writeEvery"))
  ...
  pybind11::class_<PropertyNumberOfMoleculesEvolution>(m, "PropertyNumberOfMoleculesEvolution")
      .def(pybind11::init<std::size_t, std::size_t, std::size_t, std::optional<std::size_t>>(),
           pybind11::arg("numberOfCycles"), pybind11::arg("numberOfComponents"), pybind11::arg("sampleEvery"),
  ...
  pybind11::class_<PropertyVolumeEvolution>(m, "PropertyVolumeEvolution")
      .def(pybind11::init<std::size_t, std::size_t, std::optional<std::size_t>>(), pybind11::arg("numberOfCycles"),
  ...
  pybind11::class_<System>(m, "System")
      .def(pybind11::init<std::size_t, ForceField, std::optional<SimulationBox>, bool, double, std::optional<double>,
                          double, std::optional<Framework>, std::vector<Component>, std::vector<std::vector<double3>>,
           ...
           pybind11::arg("frameworkComponents") = std::nullopt, pybind11::arg("components") = std::vector<Component>(),
           pybind11::arg("initialPositions") = std::vector<std::vector<double3>>(),
  ...
  pybind11::class_<MonteCarlo>(m, "MonteCarlo")
      ...
      .def("initialize", &MonteCarlo::initialize,
           ...
           pybind11::arg("call_back_every") = 100)
  ...
  pybind11::class_<MolecularDynamics>(m, "MolecularDynamics")
      ...
      .def("initialize", &MolecularDynamics::initialize,
           pybind11::arg("call_back_function") = pybind11::cpp_function([](void) {}),
           pybind11::arg("call_back_every") = 100)
      .def("equilibrate", &MolecularDynamics::equilibrate,
           pybind11::arg("call_back_function") = pybind11::cpp_function([](void) {}),
           pybind11::arg("call_back_every") = 100)
      .def("production", &MolecularDynamics::production,
           pybind11::arg("call_back_function") = pybind11::cpp_function([](void) {}),
           pybind11::arg("call_back_every") = 100)
...
struct type_caster<int3>
{
  ...
  static handle cast(const int3& number, return_value_policy /*policy*/, handle /*parent*/)
  {
...
struct type_caster<double3>
{
  ...
  // return_value_policy::reference_internal) and are often ignored by custom casters.
  // The return value should reflect the type hint specified by the second argument of `io_name`.
  static handle cast(const double3& number, return_value_policy /*policy*/, handle /*parent*/)
  {
    return pybind11::make_tuple(number.x, number.y, number.z).release();
  }
...
struct type_caster<double4>
{
  ...
  // return_value_policy::reference_internal) and are often ignored by custom casters.
  // The return value should reflect the type hint specified by the second argument of `io_name`.
  static handle cast(const double4& number, return_value_policy /*policy*/, handle /*parent*/)
  {
