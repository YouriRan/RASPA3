...
export struct MCMoveProbabilities
{
  ...
  MCMoveProbabilities(double translationProbability = 0.0, double randomTranslationProbability = 0.0,
                      ...
                      double swapNCMCProbability = 0.0, double swapNonEqCBMCProbability = 0.0);
  ...
  void setProbability(const Move::Types& move, double probability)
  {
    probabilities[std::to_underlying(move)] = probability;
  };
